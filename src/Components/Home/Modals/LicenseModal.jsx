...
function LicenseModal({ open, setOpen }) {
      ...
      >
        ...
        <DialogContent dividers={true}>
          ...
          >
            ...
            <p>
              <br />
              얼리폰트에서 판매/배포하는 콘텐츠(*.ttf/*.otf)는 하기의
              상업적/비상업적 목적에 대해 사용할 수 있습니다. 이외 폰트가
              탑재되는 임베디드(embedded) 용도(디바이스, 서버​, 웹폰트, 웹
              임베딩, 앱, 온라인게임 등)로 사용할 경우 별도 문의가
              필요합니다.(singsong44@euxkorea.com)
            </p>
            <p>
              <br />
              - 인쇄·출판
              <br />
              오프라인 도서, 잡지 및 정기간행물,
              브로슈어,카달로그,달력,신문광고,잡지광고,오프라인 지면 광고,제품
              패키지,명함,포트폴리오 등
              <br />- 영상
              <br />
              일반동영상,배너 영상,홍보 영상,유튜브,CF,영화,뮤직비디오 등
              <br />- 웹사이트
              <br />웹 이미지,웹 배너광고,이메일,웹툰,사내
              사보,카탈로그,뉴스레터,상세페이지,홍보페이지 등
              <br />- 상품제작
              <br />
              도장,머그컵,의류,가방,쇼핑백,명찰,마우스패드 등
              <br />- 일반문서
              <br />
              일반문서,내부문서,홍보문서, 프리젠테이션,증서,원서,신고서,무료
              배포 공문 서식,교재 등
              <br />- CI/BI
              <br />
            ...
            <p>
              <br />* 손해배상 <br />
              서비스에서 제공되는 콘텐츠의 무단 복제, 무단 사용 또는 본 약관에
              규정된 내용을 벗어나는 행위(사용범위 초과 사용 또는 콘텐츠 이용 시
              제한 사항의 위반 사용 등)는 저작권법 및 관련 법률에 의한 저작권
              침해에 해당합니다. 이 경우 회사에 발생한 손해를 배상하여야 하며,
              회사가 이를 초과하는 손해를 입은 경우 그 초과 손해도 배상해야
              합니다. 회원의 위와 같은 행위로 인하여 제삼자가 회사에 대해
              손해배상을 청구할 경우, 자신의 비용으로 회사를 면책시켜야합니다.
            </p>
            <p>
              <br />
              &lt;이용약관&gt;
            ...
            <p>
              <br />
              제1조(목적)
              <br />이 약관은 이유엑스 회사(전자상거래 사업자)가 운영하는
              얼리폰트 사이버 몰(이하 "몰"이라 한다)에서 제공하는 인터넷 관련
            ...
            <p>
              ...
              개인정보관리책임자등을 이용자가 쉽게 알 수 있도록 얼리폰트
              ...
              경우 "몰"은 개정 전 내용과 개정 후 내용을 명확하게 비교하여
              이용자가 알기 쉽도록 표시합니다.
              <br />
              ...
              및 관계법령 또는 상관례에 따릅니다.
              <br />※ 기타("www.earlyfont.com"이하 "얼리폰트")의 개인정보파일
              등록사항 공개는 행정안전부 개인정보보호 종합지원
            ...
            <p>
              ...
              경우에는 그러하지 아니합니다.
              <br />
              ③ "몰"은 이용자의 개인정보를 수집·이용하는 때에는 당해 이용자에게
              그 목적을 고지하고 동의를 받습니다.
              <br />
              ...
              개인정보의 분실, 도난, 유출, 동의 없는 제3자 제공, 변조 등으로
            ...
            <p>
              ...
              민사소송법상의 관할법원에 제기합니다.
              <br />② "몰"과 이용자 간에 제기된 전자상거래 소송에는 한국법을
              적용합니다.
            </p>
            <p>
              <br />○ 본 방침은부터 2021년 10월 1일부터 시행됩니다.
            </p>
          </DialogContentText>
        </DialogContent>
        <DialogActions>
