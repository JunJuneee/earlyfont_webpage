        ...
        <DialogContent dividers={true}>
          ...
          >
            ...
            <p>
              ...
              1. 개인정보의 처리 목적
              <br />
              &lt;이유엑스&gt;은(는) 개인정보를 다음의 목적을 위해 처리합니다.
              처리한 개인정보는 다음의 목적이외의 용도로는 사용되지 않으며 이용
              목적이 변경될 시에는 사전동의를 구할 예정입니다.
              <br />
              가. 홈페이지 회원가입 및 관리회원 가입의사 확인, 회원제 서비스
              제공에 따른 본인 식별·인증, 회원자격 유지·관리, 서비스 부정이용
              방지 등을 목적으로 개인정보를 처리합니다.
              <br />
              &lt;이유엑스&gt;은(는) 개인정보를 다음의 목적을 위해 처리합니다.
              처리한 개인정보는 다음의 목적이외의 용도로는 사용되지 않으며 이용
              목적이 변경될 시에는 사전동의를 구할 예정입니다.
              <br />
              나. 민원사무 처리 사실조사를 위한 연락·통지, 처리결과 통보 등을
              목적으로 개인정보를 처리합니다.
              <br />
              다. 재화 또는 서비스 제공 서비스 제공, 콘텐츠 제공, 본인인증,
              요금결제·정산 등을 목적으로 개인정보를 처리합니다.
              <br />
              라. 마케팅 및 광고에의 활용 신규 서비스(제품) 개발 및 맞춤 서비스
              제공, 이벤트 및 광고성 정보 제공 및 참여기회 제공 등을 목적으로
              개인정보를 처리합니다.
            </p>
            <p>
              <br />
              2. 개인정보 파일 현황
              <br />
              &lt;이유엑스&gt;가 개인정보 보호법 제32조에 따라 등록, 공개하는
              개인정보파일의 처리목적은 다음과 같습니다.
              <br />
              가. 개인정보 파일명 : 개인정보목록
              <br />- 개인정보 항목 : 이메일, 휴대전화번호, 로그인ID, 이름
              <br />- 수집방법 : 디자인플랜트/얼리폰트 홈페이지
              <br />- 보유근거 : 민원처리 및 서비스 제공
              <br />- 보유기간 : 3년
              <br />- 관련법령 : 신용정보의 수집/처리 및 이용 등에 관한 기록 :
              3년
              <br />※ 기타의 개인정보파일 등록사항 공개는 행정안전부
            ...
            <p>
              ...
              3. 개인정보의 처리 및 보유 기간
              <br />
              가. &lt;이유엑스&gt;는 법령에 따른 개인정보 보유·이용기간 또는
              정보주체로부터 개인정보를 수집시에 동의 받은 개인정보 보유,
            ...
            <p>
              ...
              <br />
              가. &lt;이유엑스&gt;은(는) 정보주체의 동의, 법률의 특별한 규정 등
              개인정보 보호법 제17조 및 제18조에 해당하는 경우에만 개인정보를
              제3자에게 제공합니다.
              <br />
              나. &lt;이유엑스&gt;은(는) 다음과 같이 개인정보를 제3자에게
              제공하고 있습니다.
              <br />
              &lt;인쇄, 간판 등 제휴된 2차 납품 업체 및 경품 발송 업체&gt;
              <br />
              - 개인정보를 제공받는 자 : 인쇄, 간판 등 제휴된 2차 납품 업체 및
              경품 발송 업체
              <br />
              - 제공받는 자의 개인정보 이용목적 : 이메일, 휴대전화번호,
              로그인ID, 이름, 서비스 이용 기록, 결제기록
            ...
            <p>
              ...
              6. 처리하는 개인정보의 항목 작성
              <br />
              가. &lt;이유엑스&gt;은(는) 다음의 개인정보 항목을 처리하고
              있습니다.
              <br />
              &lt;홈페이지 회원가입 및 관리&gt;
              <br />
              - 필수항목 : 이메일, 휴대전화번호, 로그인ID, 이름
              <br />- 선택항목 : 서비스 이용 기록, 접속 로그, 접속 IP 정보,
              결제기록
            </p>
            <p>
              <br />
            ...
            <p>
              ...
              직급 :대표
              <br />
              연락처 :032-287-7979, singsong44@euxkorea.com
            ...
            <p>
              ...
              10. 개인정보 처리방침 변경
              <br />
              가. 이 개인정보처리방침은 시행일로부터 적용되며, 법령 및 방침에
            ...
            <p>
              ...
              11. 개인정보의 안전성 확보 조치
              <br />
              &lt;이유엑스&gt;은(는) 개인정보보호법 제29조에 따라 다음과 같이
              ...
              나. 해킹 등에 대비한 기술적 대책
              <br />
              &lt;이유엑스&gt;는 해킹이나 컴퓨터 바이러스 등에 의한 개인정보
